...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_pos(ui->screen_label_20, 4, 103);
    ...
    lv_obj_set_pos(ui->screen_label_5, 8, 127);
    lv_obj_set_size(ui->screen_label_5, 89, 20);
    ...
    lv_obj_set_pos(ui->screen_img_1, 128, 36);
    ...
    lv_obj_set_pos(ui->screen_label_21, 108, 82);
    lv_obj_set_size(ui->screen_label_21, 43, 14);
    lv_label_set_text(ui->screen_label_21, "wifi : ");
    ...
    lv_obj_set_pos(ui->screen_label_22, 108, 60);
    lv_obj_set_size(ui->screen_label_22, 35, 17);
    lv_label_set_text(ui->screen_label_22, "ble : ");
    ...
    lv_obj_set_pos(ui->screen_img_2, 128, 10);
    ...
    lv_obj_set_pos(ui->screen_label_3, 150, 10);
    lv_obj_set_size(ui->screen_label_3, 40, 17);
    lv_label_set_text(ui->screen_label_3, "57%");
    ...
    lv_obj_set_pos(ui->screen_label_4, 150, 36);
    lv_obj_set_size(ui->screen_label_4, 40, 17);
    lv_label_set_text(ui->screen_label_4, "24°");
